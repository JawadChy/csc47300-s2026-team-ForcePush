document.addEventListener("DOMContentLoaded", () => {
    ...
    fetch("data/queue.json")
        ...
        .then((data) => {
            ...
            /* show initial stats from json */
            populate(valueEls, data.playersOnline, queue, wait);

            /* simulate queue countdown every 2 seconds */
...
/* converts seconds into "Xm Ys" or just "Xs" */
